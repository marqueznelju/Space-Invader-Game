...
class SpaceShip:
    ...
    def draw(self):
        pygame.draw.rect(display, deepskyblue, (self.x + self.w/2 - 8, self.y - 10, 16, 10))
...
class Bullet:
    ...
    def draw(self):
        pygame.draw.ellipse(display, deeppink, (self.x, self.y, self.d, self.d))
...
class Alien:
    ...
    def draw(self):
        pygame.draw.ellipse(display, chartreuse, (self.x, self.y, self.d, self.d))
